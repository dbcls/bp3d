...
Ext.define('Ext.ag.Store', {
	...
	load: function(options) {
		...
		if(me.request_object){
			Ext.Ajax.abort(me.request_object);
			delete me.request_object;
		}
...
/*
	initComponent : function(){
		var me = this;
		me.callParent();
		console.log(me.id,me.itemId,me.stateId);
	},
*/
	onKeyDown: function(e) {
		var me = this;
...
//		me.beforePageText,
		...
		'-',
		{
			...
			id: me.id+'-agpagesizecombobox',
			itemId: (me.itemId?me.itemId:me.id)+'-agpagesizecombobox',
			stateful: true,
			stateId: (me.stateId?me.stateId:me.id)+'-agpagesizecombobox',
			listeners : {
...
//				if(Ext.isString(value) && value.length){
//					var cd_exists = record.get('cd_exists');
//					if(!cd_exists) metaData.tdCls += ' bp3d-pick-index';
//				}
			}
...
Ext.define('Ext.ag.ColumnConceptPart', {
	extend: 'Ext.grid.column.Column',
	alias: 'widget.agcolumnconceptpart',
	width:30,
	minWidth:30,
	align: 'center',
	renderer: function(value,metaData,record,rowIndex,colIndex,store){
...
Ext.define('Ext.ag.ColumnConceptLaterality', {
	extend: 'Ext.grid.column.Column',
	alias: 'widget.agcolumnconceptlaterality',
	width:30,
	minWidth:30,
	align: 'center',
	renderer: function(value,metaData,record,rowIndex,colIndex,store){
