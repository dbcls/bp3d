...
class OBJ2IMAGE:
	...
	def __init__(self,OBJS,useRenderer=1,size = (500,500)):
...
#		self.def_opacity = 0.025
#		self.def_opacity = 0

		self.def_focus_color = (1,0,0)
		self.def_focus_opacity = 1.0
		self.def_focus_others_opacity = 0.2
#		self.def_focus_others_opacity = 1.0
...
#			print "bound():END:"+str(inspect.currentframe().f_lineno)
	...
	def animgif(self,obj_files1,obj_files2,obj_files3,dest_prefix,yRange,largerbbox,largerbboxYRange):
...
#		self.vtkRenderer.AddActor(self.objs2actor(obj_files1,self.focus_color,self.def_focus_opacity))
		...
		if obj_files3:
			for file in obj_files3:
				self.vtkRenderer.AddActor(self.obj2actor(file,self.focus_color,self.def_focus_others_opacity))
...
#		print "animgif()::"+str(inspect.currentframe().f_lineno)
		...
		bound_obj_files = []
		bound_obj_files.extend(obj_files1)
		if obj_files3:
			bound_obj_files.extend(obj_files3)

		fontBounds = self.bound(bound_obj_files)
...
#		print "png():END:"+str(inspect.currentframe().f_lineno)
	...
	def obj2animgif(self,size,obj_files1,obj_files2,obj_files3,dest_prefix,yRange,largerbbox,largerbboxYRange):
#		print "obj2animgif():START:"+str(inspect.currentframe().f_lineno)
		self.setSize(size)
		rtn = self.animgif(obj_files1,obj_files2,obj_files3,dest_prefix,yRange,largerbbox,largerbboxYRange)
