...
//			value = Ext.String.format('<div style="border:1px solid gray;background:{0};width:{1}px;height:{2}px;"> </div>',value,Ag.Def.COLOR_COLUMN_WIDTH-22,24-11);
			rtn = Ext.String.format('<div style="border:1px solid gray;background:{0};width:{1}px;height:{2}px;display:inline-block;" data-value="{3}"> </div>',value,column.getWidth()-22,24-11,value);
		}
		return rtn;
	},
	processEvent: function(type, view, cell, recordIndex, cellIndex, e,  record, row) {
