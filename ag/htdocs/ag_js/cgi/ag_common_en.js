...
//				_dump("bp3d_contents_store.beforeload()");
				try{
					...
					if(detailEl) detailEl.update('<div style="padding:10px;font-size:11px;"><img src="ext-2.2.1/resources/images/default/tree/loading.gif">Loading data ...</div>');
					if(commentDetailEl) commentDetailEl.update('<div style="padding:10px;font-size:11px;"><img src="ext-2.2.1/resources/images/default/tree/loading.gif">Loading data ...</div>');
