...
//			"get-table.cgi?type=html&table=representation_art&rep_id="+encodeURIComponent(rep_id)+"&lng=en",
			"download-art_file-list.cgi?type=html&rep_id="+encodeURIComponent(rep_id)+"&lng=en",
			"_blank",
...
//		{dataIndex:'name_j',   header:get_ag_lang('GRID_TITLE_NAME_J'),      id:'name_j',   sortable: true,  hidden:true, renderer:bp3s_parts_gridpanel_renderer},
//		{dataIndex:'name_k',   header:get_ag_lang('GRID_TITLE_NAME_K'),      id:'name_k',   sortable: true,  hidden:true, renderer:bp3s_parts_gridpanel_renderer},
...
//			height   : 50,
			...
			},
			{
				...
				html: '<div style="position:relative;width:auto;overflow:hidden;background:#dfe8f6;padding:2px;"><div style="float:left;margin-right:1em;"><label style="line-height:30px;color:#15428b;font:bold 16px tahoma,arial,helvetica,sans-serif;">BodyParts3D/Anatomography</label><label style="line-height:30px;color:black;font:normal 11px tahoma,arial,helvetica,sans-serif;"> : Select parts and Make Embeddable Model of Your Own.</label></div><table border="0" cellpadding="0" cellspacing="0" class="x-btn-wrap x-btn " style="float:left;width: auto;margin-left:1em;"><tbody><tr><td class="x-btn-left"><i>&nbsp;</i></td><td class="x-btn-center"><em unselectable="on"><button class="x-btn-text" type="button" onclick="click_information_button({url:\'info_en/userGuide/application/index.html\'})">See What You can get</button></em></td><td class="x-btn-right"><i>&nbsp;</i></td></tr></tbody></table><table border="0" cellpadding="0" cellspacing="0" class="x-btn-wrap x-btn " style="float:left;width: auto;margin-left:1em;"><tbody><tr><td class="x-btn-left"><i>&nbsp;</i></td><td class="x-btn-center"><em unselectable="on"><button class="x-btn-text" type="button" onclick="click_information_button({url:\'http://www.youtube.com/watch?v=CJLH1PqH_hg\'})">See How to</button></em></td><td class="x-btn-right"><i>&nbsp;</i></td></tr></tbody></table></div>',
				listeners: {
...
//						handler : function(){click_error_report_button();}
					...
					,'-',{
						...
						cls     : 'x-btn-icon',
						handler : function(){
							var chage_locale = "en".toLowerCase();
