...
//	{dataIndex:'name_j', header:get_ag_lang('GRID_TITLE_NAME_J'), renderer: anatomography_point_grid_renderer, id:'name_j', hidden:true},
//	{dataIndex:'name_k', header:get_ag_lang('GRID_TITLE_NAME_K')', renderer: anatomography_point_grid_renderer, id:'name_k', hidden:true},
...
//											filename,
										...
										setTimeout(function(){
											...
											if(!document.forms[form_name]){
												form = $('<form>').attr({
													action: "download-art_file-list.cgi?type=html&lng=en",
													method: "POST",
													name:   form_name,
													id:     form_name,
													style:  "display:none;",
