...
//								metaData.style = 'background:'+record.data.seg_color+';';
		...
		{text: AgLang.art_id,       dataIndex: 'art_id',       stateId: 'art_id',        width: 81, minWidth: 81, hidden: false, hideable: true},
...
//							console.log(width, height);
		...
		self.__ObjSearchMngWin.showBy(Ext.getCmp('main-viewport'),'tr');
	}
	else{
