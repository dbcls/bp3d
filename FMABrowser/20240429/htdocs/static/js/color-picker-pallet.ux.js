...
/**
 * Ext.ux.ColorPickerPallet Extension Class for ExtJs 2.0
 *
 * @author Amon
 * @version 2.0
 *
 ...
 *
 * @class Ext.ux.ColorPickerPallet
 ...
 */
Ext.ux.ColorPickerPallet = function( config ) {
	config.bodyStyle = {'padding':'3px'};
	Ext.ux.ColorPickerPallet.superclass.constructor.call( this, config );
	this.initialize( config );
}
// extend Ext.ux.ColorPickerPallet with Ext.util.Observable
Ext.extend(Ext.ux.ColorPickerPallet, Ext.util.Observable, {
	...
	cpCreateDomObjects: function() {
		...
		this.colorPalette = new Ext.ColorPalette(config);
...
/**
 * @class Ext.ux.ColorPickerPalletPanel
...
Ext.ux.ColorPickerPalletPanel = function( config ) {
	this.config = config;
	this.config.renderTo = this.config.renderTo || Ext.DomHelper.append( document.body, {}, true );
	Ext.ux.ColorPickerPalletPanel.superclass.constructor.call( this, config );
...
Ext.extend( Ext.ux.ColorPickerPalletPanel, Ext.Panel );
Ext.applyIf( Ext.ux.ColorPickerPalletPanel.prototype, Ext.ux.ColorPickerPallet.prototype );
/**
 * @class Ext.ux.ColorPickerPalletDialog
 * @extends Ext.util.ColorPicker,
 * @constructor
 ...
 * @cfg {Object} captions labels of inputs (defaults to { red: 'R', green: 'G', blue: 'B', hue: 'H°', saturation: 'S%', brightness: 'V%', hexa: 'Color', websafe: 'Websafe' })
 */
Ext.ux.ColorPickerPalletDialog = function( config ) {
	this.config = config;
	this.config.resizable = false;
	this.config.renderTo = this.config.renderTo || Ext.DomHelper.append( document.body, {}, true );
	Ext.ux.ColorPickerPalletDialog.superclass.constructor.call( this, config );
	this.domElement = Ext.get( this.config.renderTo );
	this.render( this.domElement );
	this.config.renderTo = this.body;
	this.initialize( this.config );
	...
	if(this.config.buttons){
		this.setSize( 398, 372 );
	}else{
		this.setSize( 398, 337 );
	}
	this.setTitle(this.config.title?this.config.title:'Color',this.config.iconCls?this.config.iconCls:'x-win-pallet');
}
Ext.extend( Ext.ux.ColorPickerPalletDialog, Ext.Window );
Ext.applyIf( Ext.ux.ColorPickerPalletDialog.prototype, Ext.ux.ColorPickerPallet.prototype );
